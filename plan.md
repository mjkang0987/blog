...
- 2026-06-26 [부동산] 서울 아파트값 1년 새 15%↑(부동산R114, 2025.6~2026.5)·전국 ~9%, 정부 3차례 대책에도 25개구 중 18곳 전고점 돌파·연간상승률 직전정부 추월, 대출규제로 소형 평형 주도 양극화(강남4구 전용 40~60㎡ +4.0% 1위·서울 40~60㎡ 6월4주 연초比 +6.72% vs 135㎡초과 +2.09%), 비강남권 광진·동작·성동 1년 20%+ (ko/en/ja) — 오후(19:00) 브리핑, 부동산 균형 회복(2→3). 06-24 부동산(6월1주 선별강세)과 '1년 누적 회고+평형 양극화' 앵글로 차별화, 오전 애플 IT 글과 카테고리 분리. 누적 경제 3·부동산 3·IT 4
