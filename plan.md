...
- 2026-06-26 [부동산] 동탄 아파트 연 누적 11% 돌파 — 반도체 벨트 경기 전역 동반 급등(성남 중원 +0.59%·안양 동안 +0.49% 등), 서울 매매 +0.30%(72주 연속)·전세 +0.35%(12년8개월 최고), 인천계양 A9 3기 신도시 본청약 6/27~28 (317가구 55㎡ 4.6~4.9억), 지방 DSR 3단계 연말 유예 연장(금융위 6/18) (ko/en/ja) — 07:00 오전 브리핑(추가). 부동산 균형 회복(2→3). 누적 경제 3·부동산 3·IT 4
