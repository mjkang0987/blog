...
- 2026-06-29 [부동산] 6·27 대출규제 1년 평가 — 서울 아파트값 한국부동산원 지수 기준 약 11%↑(규제 전 1년 6.7%보다 가속, 일부 통계 9.44~15%+), 9억 이하 거래비중 38→50%·전용 40~60㎡ +6.72%로 소형·외곽 쏠림(동대문 +13.89%/마포 +12.04%/성동 +8.49%), 분양권·입주권 거래 2개월 110건(직전 225건의 48.9%, 반토막), 풍선효과·실수요자 제약 (ko/en/ja) — 오후 브리핑. 같은 날 오전 경제 글(코스피 상반기 결산)과 카테고리 분리, 가장 뒤처진 부동산 선택(집계상 부동산 3→4). 직전 부동산 글(06-24 서울 6월 강세)과는 6·27 규제 1주년·정책 평가 앵글로 차별화. 1년 상승률은 출처별 차이가 커 한국부동산원 지수(약 11%) 우선 + '일부 집계/민간 통계'로 범위 완곡 처리. 누적 경제 4·부동산 4·IT 6
- 2026-06-30 [경제] 한국 경제 'K자 회복' 점검 — 5월 수출 877.5억$ 역대 최대(+53.2%, 반도체 +169.4%, 무역수지 269.5억$ 흑자, 1~5월 누적흑자 ~1,019억$) vs 5월 취업자 -4.0만(2,916만, 2024.12 이후 17개월 만 첫 감소), 청년 -25.5만(2021.1 이후 최대)·청년고용률 43.8%, 5월 CPI 3.1%·근원 2.5%, 원·달러 1,550→1,517, 오늘 5월 산업활동동향 발표일(직전 4월 전산업생산 -0.6%) (ko/en/ja) — 오전 브리핑. 가장 뒤처진 경제·부동산 중 직전(06-29 오후 부동산)과 다른 경제 선택(집계 경제 4→5). 직전 경제 글(06-29 오전 코스피 상반기 결산)과는 실물·수출·고용 앵글로 차별화. 핵심 수치는 기재부 6월 그린북+산업부 5월 수출입동향+통계청 5월 고용동향(언론) 2개 이상 교차검증, 오늘 발표되는 5월 산업활동동향 신규치는 미검증이라 단정 회피·4월 확정치만 사용. 누적 경제 5·부동산 4·IT 6
