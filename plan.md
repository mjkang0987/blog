...
- 2026-06-29 [경제] 상반기 코스피 '롤러코스터' 결산 — 연초 대비 약 100% 급등(세계 1위), 6/22 사상 최고 종가 9,114.55, 6/23 -9.99% 폭락·1단계 서킷브레이커(낙폭 약 910p 역대 최대), AI·반도체 쏠림, BOK 기준금리 2.5%(8연속 동결)·다음 금통위 7/16·매파 기조, 원·달러 1,530원대 후반 (ko/en/ja) — 오전 브리핑. 직전 06-26 글(IT 애플·부동산)과 카테고리 분리, 경제 균형 회복. ※구현·문서 불일치: plan 로그상 06-25 애플(IT)·06-26 seoul(부동산)은 '제거'로 기재됐으나 _posts에 파일 잔존 → 실제 ko 파일 집계는 경제3·부동산3·IT6이었고 이번 글로 경제4. 가장 뒤처진 경제 선택은 두 집계 모두에서 타당. 06-23 워시 FOMC/코스피 9000 글과는 상반기 결산·서킷브레이커 앵글로 차별화. 일부 일간 등락률은 단일 출처라 '일부 집계에 따르면'으로 완곡 처리, 정확 종가는 KRX 안내
